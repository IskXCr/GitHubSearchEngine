...
public class UserSearchRequest extends SearchRequest {
    ...
    public static class RequestBuilder {
        ...
        public RequestBuilder addLocation(String location) {
            qualifierLocation.append("location:").append(location).append(" ");
            return this;
        }
        ...
        public RequestBuilder addLanguage(String language) {
            qualifierLanguage.append("language:").append(language).append(" ");
            return this;
        }
...
//                    .append("per_page:100");
            ...
            reqBuilder.append("user?q=").append(URLEncoder.encode(queryBuilder.toString(), StandardCharsets.UTF_8));
            return req;
        }
