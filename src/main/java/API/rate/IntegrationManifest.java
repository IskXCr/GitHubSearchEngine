...
public class IntegrationManifest {
    ...
    public String toString() {
        ...
        sb.append(IntegrationManifest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("limit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IntegrationManifest) == false) {
            return false;
        }
        IntegrationManifest rhs = ((IntegrationManifest) other);
