...
public class CodeScanningUpload {
    ...
    public String toString() {
        ...
        sb.append(CodeScanningUpload.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("limit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CodeScanningUpload) == false) {
            return false;
        }
        CodeScanningUpload rhs = ((CodeScanningUpload) other);
