...
public class ActionsRunnerRegistration {
    ...
    public String toString() {
        ...
        sb.append(ActionsRunnerRegistration.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("limit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionsRunnerRegistration) == false) {
            return false;
        }
        ActionsRunnerRegistration rhs = ((ActionsRunnerRegistration) other);
