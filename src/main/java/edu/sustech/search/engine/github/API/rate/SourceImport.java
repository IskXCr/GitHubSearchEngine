...
public class SourceImport {
    ...
    public String toString() {
        ...
        sb.append(SourceImport.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("limit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SourceImport) == false) {
            return false;
        }
        SourceImport rhs = ((SourceImport) other);
